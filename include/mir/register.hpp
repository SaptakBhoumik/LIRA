...
class LocalRegister{
    ...
    std::size_t dereferenceable_bytes; //If 0 means the value is not set. If set the value is the number of bytes that are dereferenceable if the pointer is not null. If the pointer is null then it is not dereferenceable.
    std::size_t dereferenceable_bytes_or_null; //If 0 means the value is not set
...
class FuncParamRegister{
    ...
    bool allocalign;//If this parameter is used as the alignment of the ptr value being returned
    bool allocptr;//If this ptr paramenter is being freed or resized by the function
    bool nonnull;
    bool nopoison;
    bool nnan;
    bool ninf;
    ...
    std::size_t dereferenceable_bytes_or_null; //If 0 means the value is not set. If set the value is the number of bytes that are dereferenceable if the pointer is not null. If the pointer is null then it is not dereferenceable.
    std::size_t alignment; //If 0 means the value is not set
    std::size_t stackalignment; //If 0 means the value is not set
};
