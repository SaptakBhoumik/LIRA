...
class ConditionalJmpInst:public Inst {
    ...
    IR::TypeExprPtr true_label_type;
    IR::TypeExprPtr false_label_type;
    ...
    std::shared_ptr<IR::LabelTypeExpr> get_casted_true_label_type() const;
    std::shared_ptr<IR::LabelTypeExpr> get_casted_false_label_type() const;
...
class SwitchInst:public Inst {
    ...
    IR::TypeExprPtr default_label_type;
    ...
    std::shared_ptr<IR::LabelTypeExpr> get_casted_default_label_type() const;
