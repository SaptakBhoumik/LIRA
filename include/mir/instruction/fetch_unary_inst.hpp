...
class IntFetchUnaryInst:public FetchUnaryInst{
    ...
    public:
    IntFetchUnaryInst(IR::InstructionStmtPtr instruction_stmt, LocalDestRegisterPtr destination, IR::LiteralExprPtr value, bool nuw, bool nsw, bool zero_poison);
...
class IntFetchNegInst:public IntFetchUnaryInst {
    public:
    IntFetchNegInst(IR::InstructionStmtPtr instruction_stmt, LocalDestRegisterPtr destination, IR::LiteralExprPtr value, bool nsw);
...
class IntFetchAbsInst:public IntFetchUnaryInst {
    public:
    IntFetchAbsInst(IR::InstructionStmtPtr instruction_stmt, LocalDestRegisterPtr destination, IR::LiteralExprPtr value, bool nsw);
...
class IntFetchCLZInst:public IntFetchUnaryInst {
    public:
    IntFetchCLZInst(IR::InstructionStmtPtr instruction_stmt, LocalDestRegisterPtr destination, IR::LiteralExprPtr value, bool zero_poison);
...
class IntFetchCTZInst:public IntFetchUnaryInst {
    public:
    IntFetchCTZInst(IR::InstructionStmtPtr instruction_stmt, LocalDestRegisterPtr destination, IR::LiteralExprPtr value, bool zero_poison);
